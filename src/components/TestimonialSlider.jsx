  ...
  const testimonials = [
    {
      ...
      role: "Machine Condition Monitoring",
      text: "SenseGrid provides continuous visibility into machine health across multiple sites. Real-time alerts and actionable insights support proactive maintenance and reduce unplanned downtime." ,
    ...
    },
    {
      id: 2,
      name: "DHL Sri Lanka",
      role: "Warehouse Environmental Monitoring",
      text: "SenseGrid enables real-time monitoring of temperature, humidity, and air quality across our warehouses. Automated alerts and compliance-ready logs help protect product integrity, improve workplace safety, and support efficient operations.",
    ...
    },
    {
      ...
      text: "SenseGrid supports SLT Mobitel by providing centralized monitoring of critical infrastructure conditions. Real-time visibility and alerts help ensure operational reliability and service continuity across key facilities.",
